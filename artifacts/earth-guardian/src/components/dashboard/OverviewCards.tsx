...
import { TrendingUp, TrendingDown, Minus, Flame, Globe2, Target, Users } from "lucide-react";
  ...
  return (
    <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
      {kpiCards.map((card, i) => {
        ...
        const trendColor = card.trend === "up" ? "text-emerald-400" : card.trend === "down" ? "text-red-400" : "text-slate-400";
        ...
        return (
          ...
          >
            ...
            />
            {/* Top accent line */}
            <div className="absolute inset-x-0 top-0 h-px" style={{ background: `linear-gradient(90deg, transparent, ${card.accentColor}60, transparent)` }} />
            ...
            <div className="mt-4 flex items-end justify-between">
              ...
              <span className="text-[10px] text-slate-500">10-day trend</span>
            </div>
          </motion.div>
        );
      })}
